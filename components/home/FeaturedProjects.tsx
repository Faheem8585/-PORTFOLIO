            ...
            <div className="container">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-muted max-w-2xl mx-auto">
                        Explore my latest work in AI, machine learning, and computer vision.
                        Each project showcases innovative solutions to real-world problems.
                    </p>
                </div>
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex gap-4">
                                    <Link
                                        ...
                                        className="text-primary hover:text-primary-light font-semibold flex items-center gap-2 group/link"
                                    >
                                        View Details
